...
<%@ page import="it.unipi.dsmt.jakartaee.lab_09_ejb_interfaces.dto.BeerDTO" %><%--
...
<body>
    <div class="container-sm px-4">
        ...
        <div class="mb-2">
            ...
            <a class="btn btn-secondary" href="${pageContext.request.contextPath}/BeerSearch2Servlet">Back</a>
        </div>
    </div>
</body>
</html>
